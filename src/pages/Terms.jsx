...
const Terms = () => {
  return (
    <>
      <NavbarTwo />
      <section className="w-[90vw] mx-auto lg:w-[85vw] xl:w-[75vw]">
        <div className="flex flex-col p-4 mt-20 space-y-10 font-poppins mb-10 md:mt-32">
          <div className="py-10 font-bold text-xl">
          ...
          <div className="text-sm flex flex-col space-y-5 items-start">
            <div className="flex flex-col space-y-3">
              ...
              <p>
                ...
                conditions. Do not continue to use siddhilogistics.netlify.app
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex flex-col space-y-2">
                <h3>You must not: </h3>
                <ul>
                  <li>- Republish material from siddhivinayak.netlify.app</li>
                  <li>
                    - Sell, rent or sub-license material from
                    siddhivinayak.netlify.app
                  </li>
                  <li>
                    - Reproduce, duplicate or copy material from
                    siddhivinayak.netlify.app
                  </li>
                  <li>- Redistribute content from siddhivinayak.netlify.app</li>
                </ul>
                <p>
            ...
            <div className="flex flex-col space-y-3">
              <h1 className="text-xl font-bold">Hyperlinking to our Content</h1>
              ...
              <p>
                ...
                of Priya Optics; and (d) the link is in the context of general
              ...
              <p>
                ...
                by sending an e-mail to Priya Optics. Please include your name,
              ...
              <div>
                <h1 className="text-xl font-bold">iFrames</h1>
                <p>
              ...
              <div>
                <h1 className="text-xl font-bold">Content Liability</h1>
                <p>
              ...
              <div>
                <h1 className="text-xl font-bold">Your Privacy</h1>
                <p>Please read Privacy Policy</p>
              </div>
              <div>
                <h1 className="text-xl font-bold">Reservation of Rights</h1>
                <p>
