...
const Hero = () => {
  return (
    <section className="h-screen w-full pt-20 flex items-center justify-center md:justify-end lg:grid lg:grid-cols-2 lg:items-center lg:justify-between lg:space-x-0 transition-all duration-150 ease-linear">
      <div className="flex flex-col capitalize font-poppins space-y-1 py-10 items-start md:w-[50vw] lg:w-[60vw] lg:space-y-2">
        ...
        <div className="flex items-center space-x-5 p-1 pt-4 transition-all duration-150 ease-linear">
          <button
            className="text-white p-4 rounded-lg bg-colorOne font-semibold capitalize text-xs text-left tracking-widest transition-all duration-150 ease-linear
          "
          >
            get quotation
          </button>
