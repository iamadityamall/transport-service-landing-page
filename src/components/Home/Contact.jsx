...
const Contact = () => {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-y-6 md:gap-y-0 md:grid-cols-2 md:gap-x-5">
        <form className="text-black w-full space-y-2 p-3 rounded-xl bg-colorOne/25 lg:w-[20vw]">
          <input
            type="text"
        ...
        <div className="p-2 w-full rounded-xl bg-colorOne/40 md:h-full lg:h-full">
          <iframe
            title="office"
